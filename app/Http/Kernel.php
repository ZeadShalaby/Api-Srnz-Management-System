...
use App\Http\Middleware\CheckAdminTocken;
...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'checkvalidation' => Checkvalidation::class,
        'changelanguage' => Changelanguage::class,
        'checkadmintocken' => CheckAdminTocken::class,
        'checkusertocken' => CheckUserTocken::class,
